...
.controls{
  ...
  max-width: 1240px;
  min-width: 675px;
  background: url(https://srmcgann.github.io/assets/Bi6Kz.png) no-repeat;
...
.hideImg{
  ...
  background: url(https://srmcgann.github.io/assets/v9UDT.png) no-repeat;
  background-size: 100% 100%;
  background-position: center center;
  position: absolute;
  top: 10px;
...
.showImg{
  width: calc(50px * 1.5);
  height: calc(19px * 1.5);
  background: url(https://srmcgann.github.io/assets/1tgOjR.png) no-repeat;
  background-size: 100% 100%;
  background-position: center center;
  position: absolute;
  top: 10px;
