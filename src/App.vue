  ...
  data(){
    return {
      state: {
        ...
        baseDemoURL: 'https://code.whitehot.ninja/a/sandbox',
        rootDomain: 'code.whitehot.ninja',
        demos: [],
        loggedin: false,
        toggleLogin: null,
        globalT: 0,
        ...
        defaultAvatar: 'https://srmcgann.github.io/assets/1pnBdc.png',
        inView:[],
  ...
  methods:{
    ...
    beginSearch(page1){
      if(this.state.search.string.charAt(0) != ' '){
        ...
        if(page1){
          history.pushState(null, null, window.location.origin+"/a/?i=" + '/' + 1 + (this.state.search.string ? '/' : '') + (this.state.search.string))
          this.state.curPage = 0
        } else {
          history.pushState(null, null, window.location.origin+"/a/?i=" + '/' + (this.state.curPage+1) + '/' + (this.state.search.string))
        }
      ...
      if(vars.length>0){
        switch(vars[0]){
          case 'd':
            ...
            break
          case 'u':
            if(!vars[1]) window.location.href = window.location.origin+"/a/"
            ...
            if(vars[2]){
              ...
              if(vars[3]){
                ...
                search = '/' + vars[3]
                history.pushState(null,null,window.location.origin+"/a/?i=" + '/u/' + (this.state.user.name) + '/' + (this.state.curPage + 1)) + search
                this.beginSearch()
              }else{
                if(!this.state.curUserPage || this.state.curUserPage < 0 || this.state.curUserPage > 1e6) this.state.curUserPage = 0
                history.pushState(null,null,window.location.origin+"/a/?i=" + '/u/' + (vars[1]) + ((this.state.curUserPage) ? '/' + (this.state.curUserPage + 1) : ''))
                this.getPages()
              }
            } else {
          ...
          default:
            ...
            if(vars[0]){
              ...
              if(vars[1]){
                ...
                search = '/' + vars[1]
                history.pushState(null,null,window.location.origin+"/a/?i=" + '/' + (this.state.curPage + 1)) + search
                this.beginSearch()
              }else{
                history.pushState(null,null,window.location.origin+"/a/" + this.state.curPage ? ('?i=' + (this.state.curPage + 1)) : '')
        ...
        this.state.mode = 'default'
        this.getPages()
        if(window.location.href !== window.location.origin+"/a/") window.location.href = window.location.origin+"/a/"
      }
    },
    incrementViews(id){
    ...
    firstPage(){
      ...
      switch(this.state.mode){
        case 'user':
          window.location.href = window.location.origin+"/a/?i=" + '/u/' + this.state.user.name + search
        break
        case 'default':
          window.location.href = window.location.origin+"/a/?i=" + search
        break
        case 'single':
          window.location.href = window.location.origin+"/a/?i=" + '/d/' + this.state.curPost + search
        break
      }
    },
    lastPage(){
      ...
      switch(this.state.mode){
        case 'u':
          window.location.href = window.location.origin+"/a/?i=" + '/u/' + this.state.user.name + '/' + this.state.totalUserPages + search
        break
        case 'default':
          window.location.href = window.location.origin+"/a/?i=" + '/' + this.state.totalPages + search
        break
        case 'post':
          window.location.href = window.location.origin+"/a/?i=" + '/post/' + this.decToAlpha(this.state.curPost) + '/' + this.state.totalPages + search
        break
      }
    },
    advancePage(){
      ...
      switch(this.state.mode){
        case 'user':
          window.location.href = window.location.origin+"/a/?i=" + '/u/' + this.state.user.name + '/' + (this.state.curUserPage + 2) + search
        break
        case 'default':
          window.location.href = window.location.origin+"/a/?i=" + '/' + (this.state.curPage + 2) + search
        break
        case 'single':
          window.location.href = window.location.origin+"/a/?i=" + '/d/' + this.decToAlpha(this.state.curPost) + '/' +(this.state.curPage + 2) + search
        break
      }
    },
    regressPage(){
      ...
      switch(this.state.mode){
        case 'user':
          window.location.href = window.location.origin+"/a/?i=" + '/u/' + this.state.user.name + '/' + this.state.curUserPage + search
        break
        case 'default':
          window.location.href = window.location.origin+"/a/?i=" + '/' + this.state.curPage + search
        break
        case 'single':
          window.location.href = window.location.origin+"/a/?i=" + '/d/' + this.decToAlpha(this.state.curPost) + '/' +(this.state.curPage + 2) + search
        break
